...
from src.BayesianModels.Model import Model


class DefenderModel(Model):
    "Class that fits Bayesian Model for defenders."
    
    def _unpack_model_args(self, **kwargs):
        """Helper function to unpack model arguments."""
        n_defenders = kwargs.get('n_defenders')
        minutes = kwargs.get('minutes')
        player_idx = kwargs.get('player_idx')
        goals = kwargs.get('goals')
        assists = kwargs.get('assists')
        defensive_contributions = kwargs.get('defensive_contributions')
        goals_conceded = kwargs.get('goals_conceded')
        yellow_cards = kwargs.get('yellow_cards')
        red_cards = kwargs.get('red_cards')

        return n_defenders, minutes, player_idx, goals, assists, defensive_contributions, goals_conceded, yellow_cards, red_cards


    def fit(self, **kwargs) -> az.InferenceData:
        
        n_defenders, minutes, player_idx, goals, assists, defensive_contributions, goals_conceded, yellow_cards, red_cards = self._unpack_model_args(**kwargs)
