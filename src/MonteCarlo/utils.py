...
def extract_posteriors(trace: az.InferenceData, idx_map: dict[int, int], position: str, minutes_params_gk: dict[int, tuple], minutes_params_def: dict[int, tuple], minutes_params_mid: dict[int, tuple], minutes_params_str: dict[int, tuple]) -> dict[int, dict]:
